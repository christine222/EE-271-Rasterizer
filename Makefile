...
debug: 
	/cad/synopsys/verdi/L-2016.06-SP1-1/bin/verdi -nologo -sv -f rtl/vlog.vf -f verif/verif_vlog.vf

debug_wave:
	/cad/synopsys/verdi/L-2016.06-SP1-1/bin/verdi -nologo -sv -f rtl/vlog.vf -f verif/verif_vlog.vf -ssf wave.fsdb

#debug: $(DEBUG_LIBRARY)
#	/cad/synopsys/verdi/L-2016.06-SP1-1/bin/verdi -nologo -sv -lib work

#debug_wave: $(DEBUG_LIBRARY)
#	/cad/synopsys/verdi/L-2016.06-SP1-1/bin/verdi -nologo -sv -lib work -ssf wave.fsdb
